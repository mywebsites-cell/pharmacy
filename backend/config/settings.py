...
MIDDLEWARE = [
    ...
    'config.middleware.CustomHeaderMiddleware',
...
# Cache Configuration (used for frequently accessed dashboard/report queries)
CACHES = {
    'default': {
...
LOGGING = {
    ...
    'handlers': {
        ...
        'slow_query_file': {
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': BASE_DIR / 'logs' / 'slow-queries.log',
...
MAX_BATCH_SIZE = 1000
BILLING_TIMEOUT_SECONDS = 2
SYNC_BATCH_SIZE = 100
CACHE_TIMEOUT = 300  # 5 minutes

# Email Backend Settings (defaults to Gmail SMTP)
EMAIL_BACKEND = config('EMAIL_BACKEND', default='django.core.mail.backends.smtp.EmailBackend')
EMAIL_HOST = config('EMAIL_HOST', default='smtp.gmail.com')
EMAIL_PORT = config('EMAIL_PORT', default=465, cast=int)
EMAIL_USE_SSL = config('EMAIL_USE_SSL', default=True, cast=bool)
EMAIL_USE_TLS = config('EMAIL_USE_TLS', default=False, cast=bool)
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='mywebsites0000011@gmail.com')
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='rpszawhdnavbtlwo')
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='PharmacyPro <mywebsites0000011@gmail.com>')
RESEND_API_KEY = config('RESEND_API_KEY', default='re_MNbvvxL9_HpvKpmbks6NZrpiPTxYpFjKf')
