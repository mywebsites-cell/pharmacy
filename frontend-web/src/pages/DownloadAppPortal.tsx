        ...
        <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 border border-slate-700/60 rounded-3xl p-10 mb-12 backdrop-blur-xl relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-xl mx-auto">
              {/* Windows */}
              <a
                href="https://github.com/mywebsites-cell/pharmacy/releases/download/v1.0.11/Medicly-setup-1.0.11.exe"
                download="Medicly-setup-1.0.11.exe"
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs text-blue-300">Installer .exe • 91MB</div>
                </div>
